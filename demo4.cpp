...
pcl::PointCloud<RefPointType>::Ptr received_cloud_ptr;
...
roscloud_cb (const sensor_msgs::PointCloud2ConstPtr& input)
{
  ...
  received_cloud_ptr.reset(new pcl::PointCloud<RefPointType>);
...
pub_down_cloud=nh.advertise<sensor_msgs::PointCloud2>("cloud_pass_downsampled_",1);
  ...
  target_cloud.reset(new Cloud());
   ...
   //read pcd file
  if(pcl::io::loadPCDFile("/home/pfs-mt/spray.pcd", *target_cloud) == -1){

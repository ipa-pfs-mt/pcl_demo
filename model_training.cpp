...
main (int argc, char** argv)
{
  ...
  for (int i = 0; i < k; ++i)
  {
    std::string direct = "/home/pfs-mt/Documents/scanned_every_30_deg/";
    std::string cloud_name1 = models.at (k_indices[0][i]).first;
    std::string cloud_name = direct + cloud_name1;
